        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-12 mb-3">
                    ...
                    <div class="row">
                    <?php 
                        if(isset($_GET['cat_name']) && trim($_GET['cat_name'])!=""){
                            $cat_name = str_replace("+"," ", trim($_GET['cat_name']));
                        ...
                        $totalData = $conn->query("SELECT b_id FROM book_view WHERE b_status='public' AND b_cat_name='$cat_name'")->num_rows;

                        if($totalData<1){
                    ?>

                        <div class="col-md-12  mb-3">
                            <div class="alert alert-info border border-info">No books found in this category</div>
                        </div>
                        ...
                        <div class="col-md-12  mb-3">
                            <div class="alert alert-success border border-success"><?php if($totalData==1){ echo $totalData." book"; }else { echo $totalData." books"; } ?> found in this category.</div>
                        </div>
                        <?php
                            $limit = 6;
                            ...
                            if(isset($_GET['page']) && trim($_GET['page'])!=""){
                                ...
                                if($currPage<1 || $currPage>$totalRequiredPages){
                                    header("Location: category.php?cat_name={$cat_name}&page=1");
                                    exit();
                                }
                            ...
                            $getAllBooksQuery = "SELECT * FROM book_view WHERE b_status='public' AND b_cat_name='$cat_name' ORDER BY b_id DESC LIMIT $start, $limit";
                        ...
                        <div class="col-md-12 ">
                            <nav aria-label="Page navigation">
                                ...
                                ?>
                                    ...
                                    <a class="page-link" href="index.php?page=<?=($currPage-1); ?>" >Previous</a>
                                    </li>
                                    <li class="page-item <?=$prevBtnDisabled; ?>">
                                    ...
                                    <a class="page-link" href="index.php?page=<?=$totalRequiredPages; ?>">Last</a>
                                    </li>
                                    <li class="page-item <?=$nextBtnDisabled; ?>">
                                    <a class="page-link" href="index.php?page=<?=($currPage+1); ?>">Next</a>
                                    </li>
                                </ul>
                            </nav>
