                ...
                <div class="col-md-9 col-sm-12 mb-3">
                    ...
                    <div class="row">
                        ...
                        <?php 
                            ...
                            $totalData = $conn->query("SELECT b_id FROM book_view WHERE b_status='public'")->num_rows;
                            $limit = 6;
                            ...
                            $getAllBooksQuery = "SELECT * FROM book_view WHERE b_status='public' ORDER BY b_id DESC LIMIT $start, $limit";
